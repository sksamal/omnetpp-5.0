...
enum {NED_CONST_DOUBLE, NED_CONST_QUANTITY, NED_CONST_INT, NED_CONST_STRING, NED_CONST_BOOL, NED_CONST_SPEC};
...
class NEDXML_API FilesElement : public NEDElement
{
  ...
  public:
    ...
    virtual const char *getAttribute(const char *name) const override {return NEDElement::getAttribute(name);} // needed because of a C++ language quirk
    virtual void setAttribute(int k, const char *val) override;
    virtual void setAttribute(const char *name, const char *val) override {NEDElement::setAttribute(name, val);} // ditto
...
class NEDXML_API MsgFileElement : public NEDElement
{
  ...
  public:
    ...
    virtual int getTagCode() const override {return NED_MSG_FILE;}
    virtual int getNumAttributes() const override;
    virtual const char *getAttributeName(int k) const override;
    virtual const char *getAttribute(int k) const override;
    virtual const char *getAttribute(const char *name) const override {return NEDElement::getAttribute(name);} // needed because of a C++ language quirk
...
class NEDXML_API NamespaceElement : public NEDElement
{
  ...
  public:
    ...
    virtual int getTagCode() const override {return NED_NAMESPACE;}
    virtual int getNumAttributes() const override;
    virtual const char *getAttributeName(int k) const override;
    virtual const char *getAttribute(int k) const override;
    virtual const char *getAttribute(const char *name) const override {return NEDElement::getAttribute(name);} // needed because of a C++ language quirk
...
class NEDXML_API CplusplusElement : public NEDElement
{
  ...
  public:
    ...
    virtual int getTagCode() const override {return NED_CPLUSPLUS;}
    virtual int getNumAttributes() const override;
    virtual const char *getAttributeName(int k) const override;
    virtual const char *getAttribute(int k) const override;
    virtual const char *getAttribute(const char *name) const override {return NEDElement::getAttribute(name);} // needed because of a C++ language quirk
...
class NEDXML_API StructDeclElement : public NEDElement
{
  ...
  public:
    ...
    virtual int getTagCode() const override {return NED_STRUCT_DECL;}
    virtual int getNumAttributes() const override;
    virtual const char *getAttributeName(int k) const override;
    virtual const char *getAttribute(int k) const override;
    virtual const char *getAttribute(const char *name) const override {return NEDElement::getAttribute(name);} // needed because of a C++ language quirk
...
class NEDXML_API ClassDeclElement : public NEDElement
{
  ...
  public:
    ...
    virtual int getTagCode() const override {return NED_CLASS_DECL;}
    virtual int getNumAttributes() const override;
    virtual const char *getAttributeName(int k) const override;
    virtual const char *getAttribute(int k) const override;
    virtual const char *getAttribute(const char *name) const override {return NEDElement::getAttribute(name);} // needed because of a C++ language quirk
...
class NEDXML_API MessageDeclElement : public NEDElement
{
  ...
  public:
    ...
    virtual int getTagCode() const override {return NED_MESSAGE_DECL;}
    virtual int getNumAttributes() const override;
    virtual const char *getAttributeName(int k) const override;
    virtual const char *getAttribute(int k) const override;
    virtual const char *getAttribute(const char *name) const override {return NEDElement::getAttribute(name);} // needed because of a C++ language quirk
...
class NEDXML_API PacketDeclElement : public NEDElement
{
  ...
  public:
    ...
    virtual int getTagCode() const override {return NED_PACKET_DECL;}
    virtual int getNumAttributes() const override;
    virtual const char *getAttributeName(int k) const override;
    virtual const char *getAttribute(int k) const override;
    virtual const char *getAttribute(const char *name) const override {return NEDElement::getAttribute(name);} // needed because of a C++ language quirk
...
class NEDXML_API EnumDeclElement : public NEDElement
{
  ...
  public:
    ...
    virtual int getTagCode() const override {return NED_ENUM_DECL;}
    virtual int getNumAttributes() const override;
    virtual const char *getAttributeName(int k) const override;
    virtual const char *getAttribute(int k) const override;
    virtual const char *getAttribute(const char *name) const override {return NEDElement::getAttribute(name);} // needed because of a C++ language quirk
...
class NEDXML_API EnumElement : public NEDElement
{
  ...
  public:
    ...
    virtual int getTagCode() const override {return NED_ENUM;}
    virtual int getNumAttributes() const override;
    virtual const char *getAttributeName(int k) const override;
    virtual const char *getAttribute(int k) const override;
    virtual const char *getAttribute(const char *name) const override {return NEDElement::getAttribute(name);} // needed because of a C++ language quirk
...
/**
 * @brief GENERATED CLASS. Represents the \<enum-fields\> XML element in memory.
 *
 * DTD declaration:
 * <pre>
...
class NEDXML_API EnumFieldsElement : public NEDElement
{
  ...
  public:
    ...
    /** @name Redefined NEDElement methods, incl. generic access to attributes */
    //@{
    virtual const char *getTagName() const override {return "enum-fields";}
    virtual int getTagCode() const override {return NED_ENUM_FIELDS;}
    virtual int getNumAttributes() const override;
    virtual const char *getAttributeName(int k) const override;
    virtual const char *getAttribute(int k) const override;
    virtual const char *getAttribute(const char *name) const override {return NEDElement::getAttribute(name);} // needed because of a C++ language quirk
    ...
    virtual void setAttribute(const char *name, const char *val) override {NEDElement::setAttribute(name, val);} // ditto
    virtual const char *getAttributeDefault(int k) const override;
    virtual EnumFieldsElement *dup() const override;
    //@}
...
class NEDXML_API EnumFieldElement : public NEDElement
{
  ...
  public:
    ...
    virtual int getTagCode() const override {return NED_ENUM_FIELD;}
    virtual int getNumAttributes() const override;
    virtual const char *getAttributeName(int k) const override;
    virtual const char *getAttribute(int k) const override;
    virtual const char *getAttribute(const char *name) const override {return NEDElement::getAttribute(name);} // needed because of a C++ language quirk
...
class NEDXML_API MessageElement : public NEDElement
{
  ...
  public:
    ...
    virtual int getTagCode() const override {return NED_MESSAGE;}
    virtual int getNumAttributes() const override;
    virtual const char *getAttributeName(int k) const override;
    virtual const char *getAttribute(int k) const override;
    virtual const char *getAttribute(const char *name) const override {return NEDElement::getAttribute(name);} // needed because of a C++ language quirk
...
class NEDXML_API PacketElement : public NEDElement
{
  ...
  public:
    ...
    virtual int getTagCode() const override {return NED_PACKET;}
    virtual int getNumAttributes() const override;
    virtual const char *getAttributeName(int k) const override;
    virtual const char *getAttribute(int k) const override;
    virtual const char *getAttribute(const char *name) const override {return NEDElement::getAttribute(name);} // needed because of a C++ language quirk
...
class NEDXML_API ClassElement : public NEDElement
{
  ...
  public:
    ...
    virtual int getTagCode() const override {return NED_CLASS;}
    virtual int getNumAttributes() const override;
    virtual const char *getAttributeName(int k) const override;
    virtual const char *getAttribute(int k) const override;
    virtual const char *getAttribute(const char *name) const override {return NEDElement::getAttribute(name);} // needed because of a C++ language quirk
...
class NEDXML_API StructElement : public NEDElement
{
  ...
  public:
    ...
    virtual int getTagCode() const override {return NED_STRUCT;}
    virtual int getNumAttributes() const override;
    virtual const char *getAttributeName(int k) const override;
    virtual const char *getAttribute(int k) const override;
    virtual const char *getAttribute(const char *name) const override {return NEDElement::getAttribute(name);} // needed because of a C++ language quirk
...
class NEDXML_API FieldElement : public NEDElement
{
  ...
  public:
    ...
    virtual int getTagCode() const override {return NED_FIELD;}
    virtual int getNumAttributes() const override;
    virtual const char *getAttributeName(int k) const override;
    virtual const char *getAttribute(int k) const override;
    virtual const char *getAttribute(const char *name) const override {return NEDElement::getAttribute(name);} // needed because of a C++ language quirk
