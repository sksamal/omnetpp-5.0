...
static int littype_nums[] = {NED_CONST_DOUBLE, NED_CONST_QUANTITY, NED_CONST_INT, NED_CONST_STRING, NED_CONST_BOOL, NED_CONST_SPEC};
...
{
    return static_cast<MsgFileElement *>(getFirstChildWithTag(NED_MSG_FILE));
}
...
{
    return static_cast<MsgFileElement *>(getNextSiblingWithTag(NED_MSG_FILE));
}
...
{
    return static_cast<NamespaceElement *>(getFirstChildWithTag(NED_NAMESPACE));
}
...
{
    return static_cast<CplusplusElement *>(getFirstChildWithTag(NED_CPLUSPLUS));
}

StructDeclElement *MsgFileElement::getFirstStructDeclChild() const
{
    return static_cast<StructDeclElement *>(getFirstChildWithTag(NED_STRUCT_DECL));
}

ClassDeclElement *MsgFileElement::getFirstClassDeclChild() const
{
    return static_cast<ClassDeclElement *>(getFirstChildWithTag(NED_CLASS_DECL));
}

MessageDeclElement *MsgFileElement::getFirstMessageDeclChild() const
{
    return static_cast<MessageDeclElement *>(getFirstChildWithTag(NED_MESSAGE_DECL));
}

PacketDeclElement *MsgFileElement::getFirstPacketDeclChild() const
{
    return static_cast<PacketDeclElement *>(getFirstChildWithTag(NED_PACKET_DECL));
}

EnumDeclElement *MsgFileElement::getFirstEnumDeclChild() const
{
    return static_cast<EnumDeclElement *>(getFirstChildWithTag(NED_ENUM_DECL));
}

StructElement *MsgFileElement::getFirstStructChild() const
{
    return static_cast<StructElement *>(getFirstChildWithTag(NED_STRUCT));
}

ClassElement *MsgFileElement::getFirstClassChild() const
{
    return static_cast<ClassElement *>(getFirstChildWithTag(NED_CLASS));
}

MessageElement *MsgFileElement::getFirstMessageChild() const
{
    return static_cast<MessageElement *>(getFirstChildWithTag(NED_MESSAGE));
}

PacketElement *MsgFileElement::getFirstPacketChild() const
{
    return static_cast<PacketElement *>(getFirstChildWithTag(NED_PACKET));
}

EnumElement *MsgFileElement::getFirstEnumChild() const
{
    return static_cast<EnumElement *>(getFirstChildWithTag(NED_ENUM));
}
...
{
    return static_cast<NamespaceElement *>(getNextSiblingWithTag(NED_NAMESPACE));
}
...
{
    return static_cast<CplusplusElement *>(getNextSiblingWithTag(NED_CPLUSPLUS));
}
...
{
    return static_cast<StructDeclElement *>(getNextSiblingWithTag(NED_STRUCT_DECL));
}
...
{
    return static_cast<ClassDeclElement *>(getNextSiblingWithTag(NED_CLASS_DECL));
}
...
{
    return static_cast<MessageDeclElement *>(getNextSiblingWithTag(NED_MESSAGE_DECL));
}
...
{
    return static_cast<PacketDeclElement *>(getNextSiblingWithTag(NED_PACKET_DECL));
}
...
{
    return static_cast<EnumDeclElement *>(getNextSiblingWithTag(NED_ENUM_DECL));
}
...
{
    return static_cast<EnumElement *>(getNextSiblingWithTag(NED_ENUM));
}
...
{
    return static_cast<EnumFieldsElement *>(getFirstChildWithTag(NED_ENUM_FIELDS));
}
...
{
    return static_cast<EnumFieldsElement *>(getNextSiblingWithTag(NED_ENUM_FIELDS));
}
...
{
    return static_cast<EnumFieldElement *>(getFirstChildWithTag(NED_ENUM_FIELD));
}
...
{
    return static_cast<EnumFieldElement *>(getNextSiblingWithTag(NED_ENUM_FIELD));
}
...
{
    return static_cast<MessageElement *>(getNextSiblingWithTag(NED_MESSAGE));
}
...
{
    return static_cast<FieldElement *>(getFirstChildWithTag(NED_FIELD));
}
...
{
    return static_cast<PacketElement *>(getNextSiblingWithTag(NED_PACKET));
}
...
{
    return static_cast<ClassElement *>(getNextSiblingWithTag(NED_CLASS));
}
...
{
    return static_cast<StructElement *>(getNextSiblingWithTag(NED_STRUCT));
}
...
{
    return static_cast<FieldElement *>(getNextSiblingWithTag(NED_FIELD));
}
