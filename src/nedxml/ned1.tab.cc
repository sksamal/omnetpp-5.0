...
{
       0,   188,   188,   192,   193,   197,   199,   201,   203,   205,
     213,   218,   219,   223,   236,   244,   256,   258,   263,   273,
     286,   287,   294,   305,   314,   315,   322,   336,   345,   346,
     353,   354,   358,   385,   386,   391,   390,   402,   403,   407,
     412,   423,   429,   435,   440,   445,   450,   455,   460,   465,
     470,   481,   482,   487,   486,   498,   499,   503,   504,   505,
     506,   510,   511,   515,   523,   533,   534,   538,   546,   559,
     560,   565,   564,   576,   577,   581,   582,   587,   586,   598,
     597,   610,   609,   622,   621,   637,   646,   648,   652,   653,
     658,   657,   664,   663,   676,   677,   681,   682,   686,   694,
     693,   706,   714,   718,   719,   726,   728,   732,   733,   738,
     737,   744,   743,   756,   757,   761,   762,   766,   780,   801,
     808,   809,   814,   813,   824,   823,   836,   837,   841,   842,
     846,   847,   852,   851,   866,   867,   871,   882,   889,   893,
     912,   916,   917,   921,   928,   936,   944,   956,   957,   961,
     969,   979,   984,   988,   996,  1005,  1013,  1025,  1026,  1030,
    1035,  1042,  1047,  1051,  1059,  1064,  1068,  1077,  1085,  1089,
    1090,  1094,  1106,  1116,  1130,  1140,  1146,  1150,  1161,  1163,
    1168,  1169,  1172,  1174,  1176,  1178,  1180,  1182,  1185,  1189,
    1191,  1193,  1195,  1197,  1199,  1202,  1204,  1206,  1209,  1213,
    1215,  1217,  1220,  1223,  1225,  1227,  1230,  1232,  1234,  1237,
    1239,  1241,  1243,  1245,  1250,  1251,  1252,  1256,  1261,  1266,
    1271,  1276,  1284,  1286,  1288,  1293,  1294,  1295,  1299,  1304,
    1306,  1311,  1313,  1315,  1320,  1321,  1322,  1323,  1326,  1326,
    1328,  1328
};
#endif
...
#line 2996 "ned1.tab.cc" /* yacc.c:1646  */
  ...
  case 183:
#line 1175 "ned1.y" /* yacc.c:1646  */
    { if (np->getParseExpressionsFlag()) (yyval) = createOperator("-", (yyvsp[-2]), (yyvsp[0])); }
#line 3002 "ned1.tab.cc" /* yacc.c:1646  */
    break;

  case 184:
#line 1177 "ned1.y" /* yacc.c:1646  */
    { if (np->getParseExpressionsFlag()) (yyval) = createOperator("*", (yyvsp[-2]), (yyvsp[0])); }
#line 3008 "ned1.tab.cc" /* yacc.c:1646  */
    break;

  case 185:
#line 1179 "ned1.y" /* yacc.c:1646  */
    { if (np->getParseExpressionsFlag()) (yyval) = createOperator("/", (yyvsp[-2]), (yyvsp[0])); }
#line 3014 "ned1.tab.cc" /* yacc.c:1646  */
    break;

  case 186:
#line 1181 "ned1.y" /* yacc.c:1646  */
    { if (np->getParseExpressionsFlag()) (yyval) = createOperator("%", (yyvsp[-2]), (yyvsp[0])); }
#line 3020 "ned1.tab.cc" /* yacc.c:1646  */
    break;

  case 187:
#line 1183 "ned1.y" /* yacc.c:1646  */
    { if (np->getParseExpressionsFlag()) (yyval) = createOperator("^", (yyvsp[-2]), (yyvsp[0])); }
...
#line 3038 "ned1.tab.cc" /* yacc.c:1646  */
  ...
  case 190:
#line 1192 "ned1.y" /* yacc.c:1646  */
    { if (np->getParseExpressionsFlag()) (yyval) = createOperator("!=", (yyvsp[-2]), (yyvsp[0])); }
#line 3044 "ned1.tab.cc" /* yacc.c:1646  */
    break;

  case 191:
#line 1194 "ned1.y" /* yacc.c:1646  */
    { if (np->getParseExpressionsFlag()) (yyval) = createOperator(">", (yyvsp[-2]), (yyvsp[0])); }
#line 3050 "ned1.tab.cc" /* yacc.c:1646  */
    break;

  case 192:
#line 1196 "ned1.y" /* yacc.c:1646  */
    { if (np->getParseExpressionsFlag()) (yyval) = createOperator(">=", (yyvsp[-2]), (yyvsp[0])); }
#line 3056 "ned1.tab.cc" /* yacc.c:1646  */
    break;

  case 193:
#line 1198 "ned1.y" /* yacc.c:1646  */
    { if (np->getParseExpressionsFlag()) (yyval) = createOperator("<", (yyvsp[-2]), (yyvsp[0])); }
...
#line 3074 "ned1.tab.cc" /* yacc.c:1646  */
  ...
  case 196:
#line 1205 "ned1.y" /* yacc.c:1646  */
    { if (np->getParseExpressionsFlag()) (yyval) = createOperator("||", (yyvsp[-2]), (yyvsp[0])); }
#line 3080 "ned1.tab.cc" /* yacc.c:1646  */
    break;

  case 197:
#line 1207 "ned1.y" /* yacc.c:1646  */
    { if (np->getParseExpressionsFlag()) (yyval) = createOperator("##", (yyvsp[-2]), (yyvsp[0])); }
...
#line 3098 "ned1.tab.cc" /* yacc.c:1646  */
  ...
  case 200:
#line 1216 "ned1.y" /* yacc.c:1646  */
    { if (np->getParseExpressionsFlag()) (yyval) = createOperator("|", (yyvsp[-2]), (yyvsp[0])); }
#line 3104 "ned1.tab.cc" /* yacc.c:1646  */
    break;

  case 201:
#line 1218 "ned1.y" /* yacc.c:1646  */
    { if (np->getParseExpressionsFlag()) (yyval) = createOperator("#", (yyvsp[-2]), (yyvsp[0])); }
#line 3110 "ned1.tab.cc" /* yacc.c:1646  */
    break;

  case 202:
#line 1222 "ned1.y" /* yacc.c:1646  */
    { if (np->getParseExpressionsFlag()) (yyval) = createOperator("~", (yyvsp[0])); }
#line 3116 "ned1.tab.cc" /* yacc.c:1646  */
    break;

  case 203:
#line 1224 "ned1.y" /* yacc.c:1646  */
    { if (np->getParseExpressionsFlag()) (yyval) = createOperator("<<", (yyvsp[-2]), (yyvsp[0])); }
#line 3122 "ned1.tab.cc" /* yacc.c:1646  */
    break;

  case 204:
#line 1226 "ned1.y" /* yacc.c:1646  */
    { if (np->getParseExpressionsFlag()) (yyval) = createOperator(">>", (yyvsp[-2]), (yyvsp[0])); }
