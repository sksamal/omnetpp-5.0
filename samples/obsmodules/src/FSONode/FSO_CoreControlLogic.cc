...
void FSO_CoreControlLogic::initialize(){
 ...
 //  coreOutput = check_and_cast<OBS_CoreOutput*>((parent->getParentModule())->getSubmodule("Output"));
   oxc = check_and_cast<OBS_OpticalCrossConnect*>((parent->getParentModule())->getSubmodule("fso_switch"));

   //Initialize all statistics
 //  int numInPorts = coreInput->par("numPorts");
 //  int numOutPorts = coreOutput->par("numPorts");
   int numInPorts = oxc->par("numPorts");
   int numOutPorts = oxc->par("numPorts");
