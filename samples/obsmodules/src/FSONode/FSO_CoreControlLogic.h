...
class FSO_CoreControlLogic : public cSimpleModule{
   private:
     OBS_CoreRoutingTable *routingTable; //!< Pointer to routing table.
     OBS_CoreOutputHorizon *gatesHorizon; //!< Pointer to output horizon.
     FSO_CoreInput *coreInput; //!< Input module pointer.
     FSO_CoreOutput *coreOutput; //!< Output module pointer.
