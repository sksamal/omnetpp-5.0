 ...
 *     omnetpp::cQueue messages; //Message queue
 ...
 *   public:
 *     OBS_Burst(const char *name=nullptr, int kind=0) : OBS_Burst_Base(name,kind) {}
 ...
 * </pre>
 */
class OBS_Burst_Base : public ::omnetpp::cPacket
{
  protected:
    omnetpp::cQueue messages;
    int numPackets;
  ...
  protected:
    ...
    OBS_Burst_Base(const char *name=nullptr, int kind=0);
  ...
  public:
    ...
    virtual OBS_Burst_Base *dup() const {throw omnetpp::cRuntimeError("You forgot to manually add a dup() function to class OBS_Burst");}
    virtual void parsimPack(omnetpp::cCommBuffer *b) const;
    virtual void parsimUnpack(omnetpp::cCommBuffer *b);

    // field getter/setter methods
    virtual omnetpp::cQueue& getMessages();
    virtual const omnetpp::cQueue& getMessages() const {return const_cast<OBS_Burst_Base*>(this)->getMessages();}
    virtual void setMessages(const omnetpp::cQueue& messages);
