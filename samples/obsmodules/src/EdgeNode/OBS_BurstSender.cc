//
// Suraj: Modified to work with omnet5.0
//
...
inet::InterfaceEntry* OBS_BurstSender::registerInterface (double datarate){
    inet::InterfaceEntry *e = new inet::InterfaceEntry(this);
    ...
    inet::InterfaceToken token(0, this->getSimulation()->getUniqueNumber(), 64);
